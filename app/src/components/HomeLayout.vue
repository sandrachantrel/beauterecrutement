  ...
  <main class="main">
    ...
    <section class="button">
        ...
        <ul class="button-list">
            <li class="button-item"><a class="button-link-connexion btn btn-primary" href="../integration/login.html" role="button">CONNEXION</a></li>
            <li class="button-item"><a class="button-link-demo btn btn-info" href="TODO lien vers la page de demonstration" role="button">DEMANDER UNE DEMO</a></li>
        </ul>
    </section>

    <section class="presentation">
        <p class="presentation-content"><strong>Beauté Recrutement</strong> est un  logiciel de gestion pour vos recrutements. Simple et intuitif il vous permettra de gagner un temps precieux</p>
    </section>
    ...
    <form>
        ...
        <input type="firtsname" class="form-control" id="InputFirstNameDemoForm">
        </div>
        <div class="form-group">
